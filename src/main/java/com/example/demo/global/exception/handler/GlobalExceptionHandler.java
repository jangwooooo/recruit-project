...
import com.example.demo.domain.auth.exception.EmailAlreadyExistException;
import com.example.demo.domain.auth.exception.NotVerifyEmailException;
import com.example.demo.domain.auth.exception.UserNotFoundException;
import com.example.demo.domain.email.exception.EmailSendFailException;
